...
export default function HomePage() {
  ...
  return <PageContainer>
    ...
    <div className='gridCards page-section-gap'>
      ...
      <Card><h3>Быстрые действия</h3><div className='ui-stack-sm'><ButtonLink variant='secondary' to='/projects'><PlusCircle size={16} /> Создать проект</ButtonLink><Button><FileUp size={16} /> Импортировать БТ</Button><Button onClick={() => last && navigate(`/projects/${last.id}`)}><Clock3 size={16} /> Продолжить последний проект</Button><Button><CheckCheck size={16} /> Проверить полноту</Button><Button><FileDown size={16} /> Экспортировать БТ</Button></div></Card>
