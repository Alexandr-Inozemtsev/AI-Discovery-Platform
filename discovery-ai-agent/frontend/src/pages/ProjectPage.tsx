...
export default function ProjectPage(){
  ...
  const loadStageQuestions=async()=>{try{const r=await api<any>(`/projects/${projectId}/stage/${active}/questions`,{method:'POST'}); if(active==='PROBLEM') setProblemDraft((p:any)=>({...p, clarifying_questions:r.questions||[]})); else setStructured((st:any)=>({...st, ai_questions:r.questions||[]}))}catch{}}
